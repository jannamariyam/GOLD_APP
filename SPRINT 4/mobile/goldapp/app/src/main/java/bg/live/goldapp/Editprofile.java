        ...
        AsyncTask asyncTask = new AsyncTask() {
            ...
            protected Object doInBackground(Object[] objects) {
                ...
                Request request = new Request.Builder()
                        .url(MainActivity.url+"customer/editview/")
                        .post(body)
...
//                    JSONObject c1= new JSONObject(o.toString());
                    ...
                    for(int i=0;i<array.length();i++) {
                        ...
                        cid=c.getString("cusid");
                        t1.setText(c.getString("name"));
                        t2.setText(c.getString("phone"));
                        t3.setText(c.getString("email"));
                        t4.setText(c.getString("dob"));
                        t5.setText(c.getString("nominee"));
                        t6.setText(c.getString("nph"));
                        t7.setText(c.getString("aadr"));
                        t8.setText(c.getString("pin"));
                        t9.setText(c.getString("dist"));
                        t10.setText(c.getString("acc"));
                        t12.setText(MainActivity.uname);
                        t13.setText(MainActivity.pass);
...
//
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(),MainActivity.UID,Toast.LENGTH_SHORT).show();
...
//                                postdata.put("jdat", "2022-02-02");
                            ...
                            Request request = new Request.Builder()
                                    .url(MainActivity.url+"customer/update/")
                                    .post(body)
                                    .header("Accept", "application/json")
                                    .header("Content-Type", "application/json")
                                    .build();
